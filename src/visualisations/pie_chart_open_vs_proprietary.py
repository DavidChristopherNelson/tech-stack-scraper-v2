"""
This script generates a pie chart comparing open source and proprietary
technology market share. Warning! A lot of this is hard coded.
descriptions.
"""
...
colors1 = get_cmap('tab20')
colors2 = get_cmap('Paired')
